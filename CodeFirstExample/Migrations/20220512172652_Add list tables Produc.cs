...
{
    public partial class AddlisttablesProduc : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tblCaregories", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_tblProducts_tblCaregories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "tblCaregories",
                        principalColumn: "Id",
